...
mymodules = ['plot_config', "fire_model", "fire_utility",
...
```{python}
p = param_class(params)
```

## Check how parameters differ from the fire model defaults
...
def difference_from_default(params)
