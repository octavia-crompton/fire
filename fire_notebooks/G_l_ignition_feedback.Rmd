...
```{python}
print(all_params["batch_dict"])
print(all_params["sim_dict"])
```
...
case = res_feedback[res_feedback.alpha == 0.04].iloc[0]
...
canopy_compare(p, p_match, nfire = 1000, title = title)
